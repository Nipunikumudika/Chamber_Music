  ...
  return (
    ...
    <div className="background" style={{ backgroundImage: `url(${backgroundimg})` }}>
      ...
      <center>
        ...
        <p className="welcome"><strong>Welcome to Chamber Music!
          <br/>Online Piano Master...</strong></p>
        <div className="instructions">
          <br/>
          <p className="instructions-head">Instructions to Play Piano Master</p>
          <p className="instructions-content">&#x2022; You have to create an account using SignUp button</p>
          <p className="instructions-content">&#x2022; If you have already have an account in Chamber Music, You can click Play Now button</p>
          <p className="instructions-content">&#x2022; If you have already logged in you can also click Play Now Button </p>
          <p className="instructions-content">&#x2022; The keys are mentioned in the Piano and you can click them by using keyboard or mouse</p>
          <p className="instructions-content">&#x2022; You can try to listen our demo song and adjust the volume there</p>
          <br/>
